(function ($) {
    ...
    var imJs = {
        ...
        vedioActivation: function (e) {
            $("#play-video, .play-video").on("click", function (e) {
                ...
                $("#video-overlay, .video-overlay").append(
                    '<iframe width="560" height="315" src="https://www.youtube.com/embed/BSJvJedRf-A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                );
            });
            ...
            jQuery(document).ready(function ($) {
                ...
                function hideWord($word) {
                    ...
                    if ($word.parents(".cd-headline").hasClass("type")) {
                        ...
                        $word.parents(".cd-headline").hasClass("letters")
                    ) {
                        var bool =
                            $word.children("i").length >=
                            nextWord.children("i").length
                                ? true
                                : false;
                        hideLetter(
                            $word.find("i").eq(0),
        ...
        popupMobileMenu: function (e) {
            ...
            // nav menu
            $(
                ".body-mobile .mainmenu .has-droupdown > a, .body-mobile .mainmenu .with-megamenu > a"
            ).on("click", function (e) {
                e.preventDefault();
                $(this)
                    .siblings(".submenu, .rts-megamenu")
        ...
        textActivation: function (e) {
            $(document).ready(function () {
                ...
                if (changebox.length) {
                    ...
                    changebox.css(
                        "height",
                        changebox.parent().css("font-size")
                    );
                    ChangeSize(0);
