...
@section('title', 'Shinjiru | Services')
                    ...
                    <div class="col-xl-6">
                        <div class="accordion-service-inner">
                            <div class="title-area-start">
                                ...
                                <h2 class="title">We know how to manage educational aspirations globally</h2>
                            </div>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingOne">
                                            ...
                                            Making Easy Academic Growth
                                            </button>
                                        </h2>
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                            We provide strategies to facilitate seamless academic progress,
                                             ensuring students achieve their educational goals and succeed internationally
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
