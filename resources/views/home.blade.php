...
@section('title', 'Shinjiru | Onepage Home')
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 order-lg-1 order-md-2 order-sm-2 order-2 mt_md--50 mt_sm--50">
                    <div class="rts-title-area">
                        ...
                        <h2 class="title">We Provide Guidance for Your Educational Journey.</h2>
                    </div>
                        ...
                        <div class="row about-founder-wrapper align-items-center mt--40">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="author-inner">
                                    <a class="thumbnail" href="#"><img src="assets/images/about/image.png" alt="finbiz_founder"></a>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-inner">
                                    ...
                                    <div class="testimonial-bottom-one">
                                        <div class="thumbnail">
                                            <img src="assets/images/testimonials/Bishal.png" alt="business-testimonials">
                                        </div>
                                        <div class="details">
                                            <a href="#">
                                                <h5 class="title">Bishal Dhamala</h5>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-inner">
                                    ...
                                    <div class="testimonial-bottom-one">
                                        <div class="thumbnail">
                                            <img src="assets/images/testimonials/dineshl.png" alt="business-testimonials">
                                        </div>
                                        <div class="details">
                                            <a href="#">
                                                <h5 class="title">Dinesh Lohani</h5>
                                            </a>
                                            <span>Co-founder/IT </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
