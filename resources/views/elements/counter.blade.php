...
@section('title', 'Shinjiru | Counter Up')
...
<div class="rts-breadcrumb-area breadcrumb-bg bg_image">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title">Counter Up</h1>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        <a href="index-2.html">Home</a>
                        <span> / </span>
                        <a href="#" class="active">Counter Up</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-counter-up-area rts-section-gap counter-bg bg-2">
        <div class="container">
            <div class="row">
                <!-- counter up area -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="counter-wrapper-two">
                        <div class="single-counter">
                            ...
                            <div class="counter-details">
                                <h2 class="title"><span class="counter animated fadeInDownBig">200</span></h2>
                                <p class="disc">Abroad Study Solution</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="counter-wrapper-two">
                        <div class="single-counter">
                            ...
                            <div class="counter-details">
                                <h2 class="title"><span class="counter animated fadeInDownBig">99</span></h2>
