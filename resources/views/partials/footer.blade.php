                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="cta-left-wrapepr">
                                        <p class="cta-disc">
                                            Latest Education Consultants
                                        </p>
                                        <h3 class="title">Sign Up For Inquary</h3>
                                    </div>
                                </div>
                                <!-- cta left end -->
                                <div class="col-lg-6">
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="footer-one-single-wized">
                        <div class="wized-title">
                            ...
                            <img src="assets/images/footer/under-title.png" alt=" footer">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 col-sm-12 col-12">
                    <div class="footer-one-single-wized mid-bg">
                        <div class="wized-title">
                            ...
                            <img src="assets/images/footer/under-title.png" alt=" _footer">
                        </div>
                        <div class="opening-time-inner">
                            <div class="single-opening">
                                <p class="day">Week Days</p>
                                <p class="time">6:00 am - 5:00 pm</p>
                            </div>
                            <div class="single-opening">
                                <p class="day">Friday</p>
                                <p class="time">6:00 am- 4.00 pm</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="text-center">
                            <p>Copyright © 2024. Shinjiru Educational Consultancy.</p>
                        </div>
                    </div>
                </div>
            </div>
